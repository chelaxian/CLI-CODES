...
Все CLI, кроме Freebuff, запускаются через единообразное **TUI-меню** с псевдографикой, навигацией стрелками и динамической загрузкой каталогов моделей. Freebuff запускается напрямую.
